...
export const createAffinityUserOrder = async (payload) => {
  return api.post(`${env.medibuddyapiBaseUrl}/affinity/createAffinityUserOrder`, payload,
    {
      headers: {
        'x-api-token': env.apiToken,
        'corporateid': env.corporateid,
      },
    }
  );
};
